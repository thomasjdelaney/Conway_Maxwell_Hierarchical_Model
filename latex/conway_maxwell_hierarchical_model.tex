...
Details about all kinds of things here.
    ...
    After fitting, we measured the goodness-of-fit of each model with their log likelihood. We calculated this directly using the \texttt{logpmf} functions of the distribution objects in Python.

    \subsection{Spike count correlations}
    We measured the spike count correlations using the \texttt{corrcoef}.
